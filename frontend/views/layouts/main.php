    ...
    <body>
        ...
        <div class="wrap">
            ...
            NavBar::begin([
             ...
             $report_mnu2_itms[] = ['label' => 'ค้นประชากร', 'url' => ['person/index']];
             $report_mnu2_itms[] = ['label' => 'เพิ่มประชากร', 'url' => ['person/create']];
             $report_mnu2_itms[] = ['label' => 'ค้นหารายการทดสอบสมรรถภาพ', 'url' => ['bmitest/index']];
